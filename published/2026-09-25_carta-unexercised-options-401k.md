---
title: Why 70% of Startup Options Go Unexercised
...
**Go deeper:**
## Sources
[1] Carta — "State of Employee Equity and 401(k) Plans" (Sept 10, 2026): https://carta.com/data/state-of-employee-equity-401k
...
## Gate report
lead: PASS — Immediately delivers the 70% statistic in the first sentence with zero throat-clearing.
tension: PASS — Frames the impact with clear "Why it matters" and "The big picture" signposts, followed by a mandatory 4-bullet "By the numbers" quantitative section.
tactical-insight: PASS — Translates the data into 3 actionable, bulleted practitioner moves with bold lead-ins and clear definitions of options mechanics.
nuanced-takeaway: PASS — Honest limitation introduced with "The catch," explicitly addressing AMT, underwater options, and the correlation-vs-causation reality of the data.
tldr: PASS — Strictly follows the 4-part Smart Brevity At a Glance schema, explaining the shift, impact, tactical moves, and caveats in plain English.
